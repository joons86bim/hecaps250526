...
// panel2 공통 유틸(ESC, 날짜계산, WBS 하이라이트 등)
...
export function applyHighlightForSubtree(node, catMap){
  ...
  function dfs(n){
    ...
    // 하위 leaf가 모두 연결 + 모두 동일 상태일 때만 부모 칠하기
...
// ──────────────────────────────────────────────
// 선택/체크 등엔 반응하지 않고, 확장/축소 때만 부분 칠하기(옵션)
export function attachWbsTreeHighlightEvents(wbsTree, /*highlightFn*/ opts = {}) {
